    ...
    public function payment(Request $request, $id)
{
    ...
    // --- 10. BOOKING COMPLETED (Customer Side) Untuk generate voucher from HASTA every 3 bookings---
    public function bookingCompleted($bookingId)
    {
        ...
        // Add loyalty points
        LoyaltyService::addPoints($user->id, 100, 'Successful booking');
        ...
        if ($count % 3 == 0) {
            Voucher::create([
                ...
                'discount_percent' => collect([5,10,20,30])->random(),
                'terms_conditions' => 'Valid for car or motorcycle rental only.',
