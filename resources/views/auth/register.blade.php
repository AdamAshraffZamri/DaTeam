...
<body class="bg-gray-900">
    ...
    <div class="relative min-h-screen flex items-center justify-center bg-cover bg-center" 
        ...
        <div class="relative z-10 w-full max-w-md p-6 mt-20"> <img src="{{ asset('hasta.jpeg') }}" alt="HASTA Logo" class="w-32 mx-auto rounded shadow-lg mb-6 block">

            <h2 class="text-center text-white text-2xl font-bold mb-6">Create Account</h2>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-300 text-sm">Already have an account? <a href="{{ route('login') }}" class="text-orange-400 font-bold hover:underline">Log in</a></p>
                </div>
            </form>
        </div>
    </div>
