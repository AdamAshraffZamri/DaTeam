                    ...
                    <div class="bg-[#f2bfa0] rounded-3xl p-6 shadow-md border-2 border-white/30">
                        <div class="space-y-3 font-bold text-gray-900 text-lg">
                            ...
                            <div class="flex justify-between pt-1">
                                <span>Total Amount (Rent Only)</span>
                                <span>: {{ number_format($total - $vehicle->base_deposit, 2) }}</span>
                            </div>
                            <div class="flex justify-between border-b-2 border-black/50 pb-3">
                                <span>Deposit</span>
                        ...
                        <div class="relative pt-6 pb-2 px-2">
                            ...
                            <div class="flex justify-between relative z-10">
                                <div class="text-center">
                                    ...
                                    <p class="text-xs font-bold mt-1">{{ $pickupLoc ?? 'Student Mall, UTM' }}</p>
                                </div>
                                <div class="text-center">
                                    ...
                                    <p class="text-xs font-bold mt-1">{{ $returnLoc ?? 'Student Mall, UTM' }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 flex items-center space-x-2 text-gray-800 text-sm">
                            <i class="far fa-clock text-lg"></i>
                            <span class="font-bold">{{ $days }} Days (Rental Duration)</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-[#f2bfa0] rounded-3xl p-8 shadow-md border-2 border-white/30 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="text-center md:text-left space-y-4">
                            ...
                            <a href="{{ route('book.payment.submit', [
                                ...
                                'total' => $total,
                                'pickup_location' => $pickupLoc ?? 'Student Mall, UTM',
                                'return_location' => $returnLoc ?? 'Student Mall, UTM'
                            ]) }}" 
                               class="inline-block text-center bg-[#66ff66] hover:bg-[#52e052] text-black font-bold py-2 px-12 rounded-lg shadow-md border border-green-700 transition transform hover:scale-105">
                                Submit
                            </a>
                        </div>
                    </div>
