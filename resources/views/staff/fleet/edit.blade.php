                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="ownership_type" class="w-full bg-blue-50/50 border border-blue-100 rounded-xl px-4 py-3 font-medium text-gray-900 outline-none focus:bg-white focus:border-blue-500 appearance-none cursor-pointer" required>
                                            <option value="HASTA" {{ old('ownership_type', $vehicle->ownership_type) == 'HASTA' ? 'selected' : '' }}>HASTA</option>
                                            <option value="BROKER" {{ old('ownership_type', $vehicle->ownership_type) == 'BROKER' ? 'selected' : '' }}>BROKER</option>
                                            <option value="AGENT" {{ old('ownership_type', $vehicle->ownership_type) == 'AGENT' ? 'selected' : '' }}>AGENT</option>
                                        </select>
